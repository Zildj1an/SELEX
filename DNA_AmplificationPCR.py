...
metadata = {
    'protocolName': 'Ninja-PCR DNA Amplifier',
    'author': 'Carlos Bilbao and Pablo Villalobos',
    }


def run_custom_protocol(
        number_of_samples: int=96,
        left_pipette: 'StringSelection...'='p50-multi',
        right_pipette: 'StringSelection...'='p300-multi',
...
run_custom_protocol(**{'number_of_samples': 96, 'left_pipette': 'p10-multi', 'right_pipette': 'p10-multi', 'mastermix_volume': 18.0, 'DNA_volume': 2.0})
