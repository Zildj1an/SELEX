...
ESP8266HTTPUpdateCustom::ESP8266HTTPUpdateCustom(void)
{
}
...
HTTPUpdateResult ESP8266HTTPUpdateCustom::update(const String& url, const String& currentVersion,
...
HTTPUpdateResult ESP8266HTTPUpdateCustom::updateSpiffs(const String& url, const String& currentVersion, const String& httpsFingerprint)
{
    HTTPClient http;
    http.begin(url, httpsFingerprint);
...
HTTPUpdateResult ESP8266HTTPUpdateCustom::updateSpiffs(const String& url, const String& currentVersion)
{
    HTTPClient http;
    http.begin(url);
    return handleUpdate(http, currentVersion, true);
...
HTTPUpdateResult ESP8266HTTPUpdateCustom::update(const String& host, uint16_t port, const String& uri, const String& currentVersion,
...
HTTPUpdateResult ESP8266HTTPUpdateCustom::update(const String& host, uint16_t port, const String& uri,
...
HTTPUpdateResult ESP8266HTTPUpdateCustom::update(const String& host, uint16_t port, const String& url,
 ...
 */
int ESP8266HTTPUpdateCustom::getLastError(void)
{
    return _lastError;
}
 ...
 * @return String error
 */
String ESP8266HTTPUpdateCustom::getLastErrorString(void)
{
 ...
 */
HTTPUpdateResult ESP8266HTTPUpdateCustom::handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs)
{
 ...
 */
bool ESP8266HTTPUpdateCustom::runUpdate(Stream& in, uint32_t size, String md5, int command)
{
...
void ESP8266HTTPUpdateCustom::CheckNinjaPCR (void) {}
