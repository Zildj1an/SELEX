...
for _ in range(0, NUM_STRUCTURES_IN_DATA_BASE):
    ...
    os.system("$ROSETTA3/rna_denovo.default.linuxgccrelease -fasta aptamer.txt -nstruct %s -minimize_rna %s -secstruct_file aptamer_sec.txt -out::file::silent my_rna_structures.out" % (NUM_STRUCTURES_PER_SEQUENCE,MINIMIZATION_RNA))
    ...
    os.system("$ROSETTA3/score.default.linuxgccrelease -in:file:silent aptamer_best.out -in::file::fullatom -out:suffix _prueba -out:output")
